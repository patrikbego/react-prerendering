...
#Polyfills
	- Babel is a transpiler. 
		...
		2. Runs a script that updates/adds new functions (called “polyfill”). It “fills in” the gap and adds missing implementations.
...
#Object copying, references
	...
	- To deep clone the object we do same as above with extra for loop in check if object 
...
`let [firstName, surname] = "Ilya Kantor".split(' ');` - it is shorter way to write `let firstName = arr[0];let surname = arr[1];`
`let [a, b, c] = "abc"; // ["a", "b", "c"]`
...
- Functions provide a built-in method bind that allows to fix this.
	- same can be achieved with the wrapper for e.g.: `setTimeout(() => user.sayHi(), 1000); // Hello, John!`
...
- error object in catch has name, message, stack 
